  ...
  return (
      <>
        <header id="secure-header">
          <div className="logo">
            <a href="src/modules/Common/components/Header/Header#" title="i2c Inc.">
              <Image src={logoImage} width="39" alt="i2c logo"/>
            </a>
            <strong className="logo_text">Resource Management System</strong>
          </div>
          <div className="header-right">
            <div className="checkout-datetime">
              <strong className="title">
                ...
                <span className="datetime"> May 16, 2021 - 06:30 PM</span>
              </strong>
              <I2cButton className='btn-checkin' size="x-large" variant="primary">
                ...
                <I2cMenu className='notification-menu'>
                  ...
                  <I2cMenuItem className='notification-menu-item'>
                    ...
                    <div className='notification-details-text'>
                      ...
                      <span
                          className="emp-id">Double time for all flex time hours and earn $50 for working all 4 hours.</span>
                    </div>
                  </I2cMenuItem>
                  <I2cMenuItem className='notification-menu-item'>
            ...
            <div className="profile">
              <I2cDropdown className='profile-dropdown'>
                <I2cButton className='profileimg' slot="trigger">
                  <Image src={ProfileImage} alt="profile-photos" width="40" />
                </I2cButton>
                <I2cMenu className='profile-menu'>
                  ...
                  <I2cMenuItem className='profile-menu-item'><User className="profile-dropdown-icon" size="16"
                                                                   color="#666666"/>Profile</I2cMenuItem>
                  <I2cMenuItem className='profile-menu-item'><Setting2 className="profile-dropdown-icon" size="16"
                                                                       color="#666666"/>Settings</I2cMenuItem>
                  <I2cMenuItem onClick={invalidateSession} className='profile-menu-item'><Logout className="profile-dropdown-icon" size="16"
                                                                     color="#666666"/>Logout</I2cMenuItem>
                </I2cMenu>
              </I2cDropdown>
            </div>
          </div>
