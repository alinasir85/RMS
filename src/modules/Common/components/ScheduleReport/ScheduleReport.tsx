        ...
        <div className="scheduleReport">
            <div className="component-container">
                <div className="component-header">
                    <div className="col-6"> <h2>Schedule Report</h2></div>
              ...
              <DateRangeDropdown isFlex={true} />
                ...
                <div className="component-footer">
                    <div className="col-md-12">
                        <span className='data-labels'><div className="blue"></div>Scheduled</span>
                        <span className='data-labels'><div className="orange"></div>Unscheduled</span>
                    </div>
                </div>
            </div>
        </div>
