            ...
            <div className='p-3'>
                <div className="d-flex align-items-center resource-detail">
                    <div className="me-3 position-relative">
                        <Link href='/supervisor-attendance' className="btn btn-back btn-sm ps-0 pe-1 font-12 me-3"><i><ArrowLeft size="20" color="#222" /></i></Link><Image src={userImage} className="media-img" alt="user pic" />
                    </div>
                                            ...
                                            <th className={`text-center ${componentClasses['status-dropdown']}`}>
                                                <div className="dropdown d-inline-block  ">
                                                    ...
                                                    <ul className="dropdown-menu menu-right">
                                                        <li><a className={`dropdown-item ${componentClasses['dropdown-item']}`} href="src/modules/Users/Supervisor/SupervisorAttendance/Supervisor-Attendance-Report/SupervisorAttendanceReport#">Aprove All</a></li>
                                                        <li><a className={`dropdown-item ${componentClasses['dropdown-item']}`} href="src/modules/Users/Supervisor/SupervisorAttendance/Supervisor-Attendance-Report/SupervisorAttendanceReport#">Reject all</a></li>
                                                    </ul>
                                                </div>
                                            </th>
                                        </tr>
