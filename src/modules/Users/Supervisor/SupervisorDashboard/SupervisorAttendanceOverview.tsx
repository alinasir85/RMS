...
import GraphChart from '../../../Common/components/View/GraphChart';
import LineChart from '../../../Common/components/View/LineChart';
import { Diagram, Profile2User, UserTick, UserRemove, Clock } from 'iconsax-react';
import Highcharts from "highcharts";
import data from './SupervisorAttendanceOverview.json';
import DateRangeDropdown from '../../../Common/components/DateRangeDropdown/DateRangeDropdown';

const SupervisorAttendanceOverview = () => {
    let value = data;
...
export default SupervisorAttendanceOverview;
