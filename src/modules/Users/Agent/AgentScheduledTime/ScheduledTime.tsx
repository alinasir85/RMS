import { I2cBadge, I2cButton } from '@webcomponents/i2cwebcomponents/dist/react';
                                                        ...
                                                        <tr key={dataSet.recordId}>
                                                            ...
                                                            <td className="text-end pe-4">
                                                                ...
                                                                } */}
                                                                {
                                                                    ...
                                                                    <I2cButton className='btn-checkin d-md-inline-block d-none' size="small" variant="primary">
                                                                        Opt In
                                                                    </I2cButton>
                                                                }
