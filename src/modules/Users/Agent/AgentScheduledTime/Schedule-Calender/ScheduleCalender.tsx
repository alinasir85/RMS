...
import awardIcon from '../../../../../../public/assets/award-tag.svg';
...
const ScheduleCalender = () => {
    ...
    const calenderInit = () => {
        ...
        const lastDayOfMonth = new Date(new Date(prevMonth).getFullYear(), new Date(prevMonth).getMonth()+1, 0); // Date(prevMonth).getMonth() will return 9 and we will add 1 to it to get the exact previous month
        ...
        <div className={`${classes['tbl-container']}`}>
            <div className={`${classes['calendar-header']} d-md-flex ps-4 pe-4 justify-content-between align-items-center`}>
                ...
                <div className={`${classes['calendar-month-controls']} order-2`}>
                    <a href="src/modules/Users/Agent/AgentScheduledTime/Schedule-Calender/ScheduleCalender#" onClick={() => monthNavigate('prev')}>
                    ...
                    <a href="src/modules/Users/Agent/AgentScheduledTime/Schedule-Calender/ScheduleCalender#" onClick={() => monthNavigate('next')}>
            ...
            {/* <ReactTooltip id="main-tool" effect='solid' place='top' type='dark'  /> */}
